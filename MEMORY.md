...
- **claude-10 — DONE**: Seniority prompt tuning (`_SYSTEM_PROMPT` rules, D-10-01). Skills lexicon split (`utils/skills_lexicon.py`, D-10-02). Quality gate `_MIN_VALID_SKILLS` 1→2 (D-10-03). 180 tests green.
